        ...
        <nav class="sidebar__container">
            ...
            <div class="sidebar__content">
                <div class="sidebar__list">
                    ...
                    <a href="/jobs" class="sidebar__link {{ request()->is('job*') ? 'active-link' : '' }}">
                ...
                <div class="sidebar__list">
                    <a href="/forums"
                        class="sidebar__link {{ request()->is('forums*') || request()->is('view_forum*') || request()->is('new_forum*') ? 'active-link' : '' }}">
