        ...
        <div class="card-body">
            ...
            <form id="survey-form" wire:submit.prevent="saveBuiltIn" class="forms-sample">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" id="forFirstTimers"
                                wire:model="forFirstTimers">
                            For first time users
                        </label>
                    </div>
                    <label for="surveyTitle">Title:</label>
                    <input type="text" class="form-control" id="surveyTitle" autocomplete="off"
                        wire:model="surveyTitle" placeholder="Title" required>

                    <label for="surveyDesc">Description:</label>
                    <input type="text" class="form-control" id="surveyDesc" autocomplete="off"
                ...
                <div class="form-group" wire:key="question-{{ $questionIndex }}">
                    ...
                    @endif
                        ...
                        <input type="text" name="question_desc" class="form-control"
                            id="question_{{ $questionIndex }}" autocomplete="off"
