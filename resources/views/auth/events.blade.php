    ...
    <section class="tab">
        ...
        <article class="blog-post">
            ...
            <div class="blog-post__info">
                <h2 class="blog-post__title">Programming Contest</h2>
        ...
        @foreach ($events as $event)
            <article class="blog-post">
                ...
                <div class="blog-post__info">
                    <h2 class="blog-post__title">{{ $event->title }}</h2>
                    <div class="blog-post__date">
                        <span>{{ \Carbon\Carbon::parse($event->event_start)->format('F j, Y g:i A') }} -
                            {{ \Carbon\Carbon::parse($event->event_end)->format('F j, Y g:i A') }}</span>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
                    <a href="#" class="blog-post__cta">Read More ></a>
                </div>
